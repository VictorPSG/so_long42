...
/*   Updated: 2024/12/02 19:39:37 by victda-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_grass(t_core *core)
{
	...
	path[8] = "assets/texture/grass_middle_down.xpm";
	path[9] = "assets/texture/grass_middle_left.xpm";
	path[10] = "assets/wall.xpm";
	path[11] = NULL;
